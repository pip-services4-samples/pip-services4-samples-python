...
class BeaconsDirectClientV1(DirectClient, IBeaconsClientV1):
    def __init__(self):
        ...
        self._dependency_resolver.put('controller', Descriptor('beacons', 'service', '*', '*', '1.0'))
    ...
    def get_beacons_by_filter(self, context: Optional[IContext], filter: FilterParams, paging: PagingParams) -> dict:
        ...
        result = self._controller.get_beacons_by_filter(context, filter, paging)
        timing.end_timing()
        return result
    ...
    def get_beacon_by_id(self, context: Optional[IContext], id: str) -> BeaconV1:
        ...
        result = self._controller.get_beacon_by_id(context, id)
        timing.end_timing()
        return result
    ...
    def get_beacon_by_udi(self, context: Optional[IContext], udi: str) -> BeaconV1:
        ...
        result = self._controller.get_beacon_by_udi(context, udi)
        timing.end_timing()
        return result
    ...
    def calculate_position(self, context: Optional[IContext], site_id: str, udis: List[str]) -> Any:
        ...
        result = self._controller.calculate_position(context, site_id, udis)
        timing.end_timing()
        return result
    ...
    def create_beacon(self, context: Optional[IContext], entity: BeaconV1) -> BeaconV1:
        ...
        result = self._controller.create_beacon(context, entity)
        timing.end_timing()
        return result
    ...
    def update_beacon(self, context: Optional[IContext], entity: BeaconV1) -> BeaconV1:
        ...
        result = self._controller.update_beacon(context, entity)
        timing.end_timing()
        return result
    ...
    def delete_beacon_by_id(self, context: Optional[IContext], id: str) -> BeaconV1:
        ...
        result = self._controller.delete_beacon_by_id(context, id)
        timing.end_timing()
        return result
