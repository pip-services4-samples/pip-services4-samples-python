...
class BeaconsMockClientV1(IBeaconsClientV1):
    ...
    def create_beacon(self, context: Optional[IContext], beacon: BeaconV1) -> BeaconV1:
        if beacon is None:
            return
    ...
    def update_beacon(self, context: Optional[IContext], beacon: BeaconV1) -> BeaconV1:
        try:
    ...
    def delete_beacon_by_id(self, context: Optional[IContext], beacon_id: str) -> BeaconV1:
        try:
